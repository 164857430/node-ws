...
const UUID = process.env.UUID || '8b1fb9a3-7303-4503-99a9-4c8851891265'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const DOMAIN = process.env.DOMAIN || 'renddd-latest.onrender.com';       // 填写项目域名或已反代的域名，不带前缀，建议填已反代的域名
