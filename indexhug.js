...
const UUID = process.env.UUID || 'e6ca2eea-625e-4029-8c3b-c5c22cc44e9c'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const DOMAIN = process.env.DOMAIN || 'cubarafael-bin.hf.space';       // 填写项目域名或已反代的域名，不带前缀，建议填已反代的域名
